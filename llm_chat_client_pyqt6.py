...
class LoadingScreen(QWidget):
    ...
    def __init__(self):
        ...
        title.setFont(QFont("SF Pro Text", 32, QFont.Weight.Bold))
        ...
        loading_label.setFont(QFont("SF Pro Text", 11))
...
class LLMChatClient(QMainWindow):
    ...
    def create_sidebar(self):
        ...
        history_label.setFont(QFont("SF Pro Text", 11, QFont.Weight.Bold))
    ...
    def create_chat_area(self):
        ...
        self.chat_display.setFont(QFont("SF Pro Text", 12))
        ...
        self.input_text.setFont(QFont("SF Pro Text", 12))
    ...
    def create_header(self):
        ...
        title_label.setFont(QFont("SF Pro Text", 16, QFont.Weight.Bold))
        ...
        self.token_label.setFont(QFont("SF Pro Text", 11))
    ...
    def create_conversation_item(self, conv_data):
        ...
        title_label.setFont(QFont("SF Pro Text", 11))
...
class SettingsDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        title.setFont(QFont("SF Pro Text", 16, QFont.Weight.Bold))
        title.setStyleSheet(f"color: {COLORS['text']};")
        layout.addWidget(title)

        # Sampling mode selection
        mode_label = QLabel("Sampling Mode:")
        mode_label.setFont(QFont("SF Pro Text", 12))
        ...
        temp_desc.setFont(QFont("SF Pro Text", 10))
        ...
        top_p_desc.setFont(QFont("SF Pro Text", 10))
